...
Tree.prototype.DFSelect = function(filter) {
  let depth=0, result =[], value=this.value;
  // console.log(this);
  // console.log(`value : ${value}, depth : ${depth}` ); 
  if(filter(value, depth)) result.push(this.value);
  const traverse=(tree)=>{
...
var leaf6 = branch3.addChild(6);
var leaf7 = branch3.addChild(7);
console.log(root1.DFSelect((value, depth)=>{
  // console.log(`value : ${value}, depth : ${depth}` );
  return depth===2;
}));
// console.log(root1.isDescendant(leaf6));
// console.log(root1.addChild(leaf8));
// console.log(root1);
